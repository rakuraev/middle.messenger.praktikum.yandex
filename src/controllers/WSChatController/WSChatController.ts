...
import WSTransport, { WSEvents } from '../../core/WSTransport/WSTransport';
import { StateKeys } from '../../store';
import isArray from '../../utils/typeguards/isArray';
...
class WSChatsController extends WSTransport {
  offset = 0;
...
export default WSChatsController;
